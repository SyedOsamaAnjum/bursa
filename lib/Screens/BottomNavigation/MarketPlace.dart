...
class MarketPlace extends StatefulWidget {
  static String id = 'MarketPlace Screen';
  final String name;
  final String symbol;
  ...
  MarketPlace({this.symbol, @required this.name,this.list,this.AccessToken});
...
class _MarketPlaceState extends State<MarketPlace> {
  ...
  loadStocks(){
    ...
    String ur = "$url"+'/stocks/GetStocksHistory/'+widget.symbol;
    http.get(ur,)
        .then((response) async{
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, index) {
                        if(index!=null){ String date = list[index]['dateTime'];
                        var dt = date.split('T');
                        String x = dt[1];
                        var xy = x.split('.');
                        String time = xy[0];
