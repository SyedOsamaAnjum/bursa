...
class ReitChart extends StatefulWidget {

  static const id = 'ReitChart';
  ...
  ReitChart({this.name, this.symbol, this.AccessToken, this.list});

  @override
  _ReitChartState createState() => _ReitChartState();
}

class _ReitChartState extends State<ReitChart> {
  ...
  loadStocks(){
    ...
    print(widget.symbol);
    String ur = "$url"+'/stocks/GetReitHistory/'+widget.symbol;
    http.get(ur,)
        .then((response) async{
