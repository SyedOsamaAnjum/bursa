...
class LeapChart extends StatefulWidget {

  static const id = 'LeapChart';
  ...
  LeapChart({this.name, this.symbol, this.AccessToken, this.list});

  @override
  _LeapChartState createState() => _LeapChartState();
}

class _LeapChartState extends State<LeapChart> {
  ...
  loadStocks(){
    ...
    String ur = "$url"+'/stocks/GetLeapHistory/'+widget.symbol;
    http.get(ur,)
        .then((response) async{
