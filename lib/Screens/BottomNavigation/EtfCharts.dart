...
class EtfChart extends StatefulWidget {


  static const id = 'EtfChart';
  ...
  EtfChart({this.name, this.symbol, this.AccessToken, this.list});


  @override
  _EtfChartState createState() => _EtfChartState();
}

class _EtfChartState extends State<EtfChart> {
  ...
  loadStocks(){
    ...
    String ur = "$url"+'/stocks/GetETFHistory/'+widget.symbol;
    http.get(ur,)
        .then((response) async{
