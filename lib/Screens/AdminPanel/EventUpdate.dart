...
class EventUpdate extends StatefulWidget {
  ...
  EventUpdate({this.eventName, this.startDate, this.endTime, this.video, this.img, this.price, this.description, this.currentId, this.token, this.eventId});
                                  ...
                                  http.put(u,headers:header, body: sb).then((value) async{
                                    ...
                                    if(value.statusCode >= 200 && value.statusCode <300){
                                      ...
                                      if(_video != null){
                                        ...
                                        await dio.post("$url/event/UploadEventVideo/${widget.eventId}",data: formData).then((value) {
                                      ...
                                      if(_img != null){
                                        ...
                                        await dio.post("$url/event/UploadEventImage/${widget.eventId}",data: formData).then((value) {
                                          int code = value.statusCode;
                                          print(code);
                                          Scaffold.of(context).showSnackBar(
                                      ...
                                      await connection.invoke("SendNotification",args: [eventName.text,widget.currentId]);
                                    }
                                  });
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text("Email : ${userList[2]}",
                      style: textStyle.copyWith(
                          fontWeight: FontWeight.bold,
                          color: amber,
                          fontSize: 12
